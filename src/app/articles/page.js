          ...
          <div className="flex flex-wrap justify-center gap-3 mt-8">
            {categories.map((cat) => (
              <button
                ...
                className={`px-6 py-2 rounded-xl text-sm font-bold transition-all duration-300 cursor-pointer ${filter === cat
            ...
            {filteredArticles.map((a, idx) => (
              ...
              >
                ...
                <div className="h-56 bg-gray-200 relative overflow-hidden">
                  {a.thumbnail ? (
                    <Image fill src={a.thumbnail} alt={a.title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                  ) : (
