                ...
                <div className="flex-1">
                    ...
                    <div className="flex gap-3">
                        ...
                        <button 
                            ...
                            className="p-3 bg-white/20 hover:bg-white/40 rounded-xl transition text-white"
                        >
                ...
                <div key={idx} className="glass-card p-6 rounded-3xl hover-3d flex items-center gap-5 group">
                   ...
                   <div className="flex items-center gap-2">
                       <button 
                         ...
                         className="p-3 text-gray-400 hover:text-indigo-600 bg-white/50 hover:bg-white rounded-xl transition"
                       >
          ...
          <div className="relative">
             <div className="bg-teal-700 text-white p-8 rounded-[2.5rem] shadow-2xl sticky top-32 overflow-hidden">
                ...
                <div className="mt-8 pt-6 border-t border-teal-600 text-center relative z-10">
                   <button className="w-full py-3 bg-white text-teal-800 font-bold rounded-xl hover:bg-teal-50 transition shadow-lg flex items-center justify-center gap-2">
                      <MapPin size={18} />
